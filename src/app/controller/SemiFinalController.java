...
public class SemiFinalController extends JanelaJAVAFX{
    ...
    void initialize() {
    	adicionar();
    	atualizarPartidas();
        assert btnCadastrarPartida != null : "fx:id=\"btnCadastrarPartida\" was not injected: check your FXML file 'SemiFinal.fxml'.";
        assert btnRandown != null : "fx:id=\"btnRandown\" was not injected: check your FXML file 'SemiFinal.fxml'.";
        assert btnVoltarMenu != null : "fx:id=\"btnVoltarMenu\" was not injected: check your FXML file 'SemiFinal.fxml'.";
